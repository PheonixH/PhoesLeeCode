...
//    //方案一 ： 链表  效率低
//    private int val;
//    private datestruct.MedianFinder next;
//    private datestruct.MedianFinder front;
//    private int size;
//
//    /**
//     * initialize your data structure here.
//     */
//    public datestruct.MedianFinder() {
//        this.setVal(0);
//        this.setFront(null);
//        this.setNext(null);
//    }
...
//        if (this != null) {
//            if(size == 0){
//                datestruct.MedianFinder n = new datestruct.MedianFinder(num);
//                this.next = n;
//                n.front = this;
//                size++;
//                return;
//            }
//            datestruct.MedianFinder m = this.next;
...
//        }
//        if (size / 2 * 2 == size) {
//            datestruct.MedianFinder p = this.next;
//            datestruct.MedianFinder q = this.next.next;
//            int x = size / 2 - 1;
//            double res = 0;
//            while (x > 0) {
//                p = q;
...
//    }
//
//    public datestruct.MedianFinder(int v) {
//        this.setVal(v);
//        this.setFront(null);
//        this.setNext(null);
//    }
...
//    }
//
//    public datestruct.MedianFinder getNext() {
//        return next;
//    }
//
//    public void setNext(datestruct.MedianFinder next) {
//        this.next = next;
//    }
//
//    public int getSize() {
...
//    }
//
//    public datestruct.MedianFinder getFront() {
//        return front;
//    }
//
//    public void setFront(datestruct.MedianFinder front) {
//        this.front = front;
//    }
...
/**
 * Your datestruct.MedianFinder object will be instantiated and called as such:
 * datestruct.MedianFinder obj = new datestruct.MedianFinder();
 * obj.addNum(num);
